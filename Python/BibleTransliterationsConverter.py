...
# -*- coding: utf-8 -*-
#
# BibleTransliterationsConverter.py
#
# Module handling BibleTransliterations.xml to produce C and Python data tables
#
...
class BibleTransliterationsConverter:
    """
    Class for handling and converting BibleTransliterations.
    """
    ...
    def __init__( self ) -> None:
        ...
        self._filenameBase = 'BibleTransliterations'
    ...
    # end of BibleTransliterationsConverter.__init__
    ...
    def __str__( self ) -> str:
        ...
        return result
    # end of BibleTransliterationsConverter.__str__


    def __len__( self ):
        """ Returns the number of items loaded. """
        return len( self._XMLTree )
    # end of BibleTransliterationsConverter.__len__
    ...
    def loadAndValidate( self, XMLFileOrFilepath=None ):
        ...
        if self._XMLTree is None: # We mustn't have already have loaded the data
            ...
            if BibleOrgSysGlobals.strictCheckingFlag:
                self._validate()
        return self
    # end of BibleTransliterationsConverter.loadAndValidate
    ...
    # end of BibleTransliterationsConverter._load
    ...
    # end of BibleTransliterationsConverter._validate
    ...
    def exportDataToPython( self, filepath=None ):
        ...
        with open( filepath, 'wt', encoding='utf-8' ) as myFile:
            myFile.write( "# {}\n#\n".format( filepath ) )
            myFile.write( "# This UTF-8 file was automatically generated by BibleTransliterationsConverter.py V{} on {}\n#\n".format( PROGRAM_VERSION, datetime.now() ) )
...
# end of BibleTransliterationsConverter class
...
# end of BibleTransliterationsConverter.py
